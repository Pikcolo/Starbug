...
|---|---|---|---|---|
| **1** | **💬 ทักทาย & ต้อนรับ (Greeting)** | ต้อนรับผู้ใช้ด้วยมุกบาริสต้าภารตะ พร้อม Quick Reply ทางลัด | `สวัสดีครับ`, `หวัดดีจ้า`, `hello` | ส่งรูปบาริสต้าดอลลี่ + ข้อความต้อนรับ + Quick Reply ปุ่มทางลัด |
| **2** | **📖 คู่มือช่วยเหลือ (Help Guide)** | สรุป 8 แนวทางการสั่งการระบบบอท พร้อม Quick Reply | `ช่วยด้วย ใช้ยังไง`, `มีคำสั่งอะไรบ้าง` | ข้อความคู่มือ 8 ข้อ + Quick Reply ปุ่มทางลัด |
