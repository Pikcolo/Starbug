...
INTENT_TRAINING_CORPUS = {
    ...
    IntentType.FORTUNE: [
        "ดูดวงกาแฟให้หน่อย วันนี้เป็นไงบ้าง", "หมอดูบาริสต้า", "ทายดวงวันนี้", "กาแฟเสริมดวง", "ทำนายดวงชะตา"
    ],
    IntentType.SECRET_RECIPE: [
        "ขอสูตรลับสตาร์บัคส์หน่อย", "สูตรลับสายป่วน", "custom secret menu", "สูตรสั่งบาริสต้า", "สูตรลับในตำนาน"
    ],
